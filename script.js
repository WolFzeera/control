...
const blocksData = [
    ...
    { hour: 20, text: 'Oito da noite, está inquieta? Sei que adora desafios, então estou te desafiando. Eu sei que quer ver o final, mas será que ele vale a pena? Vai ter que descobrir. Aqui eu mando, as regras são minhas e você é minha, pequena... não tem opção a não ser... Obedecer.' },
